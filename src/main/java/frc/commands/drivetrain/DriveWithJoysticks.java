...
public class DriveWithJoysticks extends Command {
  ...
  protected void execute() {
     ...
     */
    case 0:
      Robot.drivetrain.driveLeft(Robot.oi.getDriveTrainLeftJoystick());
      Robot.drivetrain.driveRight(Robot.oi.getDriveTrainRightJoystick());
      break;
    ...
    case 2:
      Robot.drivetrain.driveLeft(
          Robot.oi.getDriveTrainLeftJoystick() + Robot.oi.driverJoystick.getRightStickRaw_X());
